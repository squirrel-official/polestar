...
classNames = []
classFile = "/usr/local/polestar/model/coco/coco.names"
with open(classFile, "rt") as f:
    classNames = f.read().rstrip("\n").split("\n")

# This is to pull the information about what each object should look like
configPath = "/usr/local/polestar/model/coco/ssd_mobilenet_v3_large_coco_2020_01_14.pbtxt"
weightsPath = "/usr/local/polestar/model/coco/frozen_inference_graph.pb"
